...
type Config struct {
	...
	// CostSummary is a pre-formatted cost table for the allocator's observation.
	// When set, it's appended to the BUDGET METRICS block so the allocator can
	// make cost-informed tier decisions. Generated by modelconfig.FormatCostSummary.
	CostSummary string
